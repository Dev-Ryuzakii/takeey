...
const SignIn = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-1 justify-center items-center h-screen bg-gray-50">
        <div className="flex flex-col items-center">
          ...
          <button
            ...
            className="w-72 rounded-lg flex items-center justify-center gap-4 h-12 border border-gray-300 hover:bg-gray-100 transition my-2"
          >
            <img
        ...
        {showForm ? (
          ...
          <div
            className="space-y-6 mx-36 transition-opacity duration-500 ease-in-out"
          ...
          // Show text when `showForm` is false
          <div
      ...
      or {" "}
      <Link to="/signup" className='font-semibold text-primary-500'>Create Account</Link>
    </p>

    <p className='text-gray-500 my-8'>By using Takeey you agree to the  {" "}
