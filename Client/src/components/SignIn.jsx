...
const SignIn = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-1 justify-center items-center h-screen bg-gray-50 px-4">
        <div className="flex flex-col items-center max-w-md">
          ...
          <button
            ...
            className="w-72  max-w-sm rounded-lg flex items-center justify-center gap-4 h-12 border border-gray-300 hover:bg-gray-100 transition my-2"
          >
            <img
      ...
      {showForm ? (
        ...
        <div
          className="text-center mx-36 transition-opacity duration-500 ease-in-out"
  ...
  or{" "}
  <Link to="/signup" className="font-semibold text-primary-500">
    Create Account
  </Link>
</p>

<p className="text-gray-500 mx-10 my-8 text-sm sm:text-base md:text-lg px-4 text-center sm:mx-12">
